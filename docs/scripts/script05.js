...
const questions = [
  {
    ...
    file: "exercises/05/create-dict.py",
    tests: "exercises/05/create-dict.test.py"
  },
  {
    title: "Waarde uitlezen",
    description:
      "Gegeven <code>person = { name: \"Anna\", city: \"Brugge\" }</code>. Print de waarde van <code>city</code>.",
    file: "exercises/05/read-value.py",
    tests: "exercises/05/read-value.test.py"
  },
  {
    ...
    file: "exercises/05/add-key.py",
    tests: "exercises/05/add-key.test.py"
  },
  {
    ...
    file: "exercises/05/update-value.py",
    tests: "exercises/05/update-value.test.py"
  },
  {
    title: "Key verwijderen",
    description:
      "Gegeven <code>info = { a: 1, b: 2 }</code>. Verwijder de key <code>b</code> en print de dictionary.",
    file: "exercises/05/delete-key.py",
    tests: "exercises/05/delete-key.test.py"
  },
  {
    ...
    file: "exercises/05/nested-dict.py",
    tests: "exercises/05/nested-dict.test.py"
  }
];